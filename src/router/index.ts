...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/patients/new",
      name: "patients-new",
      component: () => import("@/pages/patients/NewPatientPage.vue"),
      meta: { requiresAuth: true, requiresClinic: true },
    },
    {
      path: "/patients/:id",
    ...
    // Medical records
    {
      ...
      name: "medical-records-new",
      component: () => import("@/pages/medical-records/NewRecordPage.vue"),
      meta: { requiresAuth: true, requiresClinic: true },
    },
    {
      path: "/records",
      name: "records",
      component: () => import("@/pages/medical-records/RecordsPage.vue"),
      meta: { requiresAuth: true, requiresClinic: true },
    },
    // Appointments
    {
    ...
    },
    {
      ...
      component: () => import("@/pages/appointments/NewAppointmentPage.vue"),
      meta: { requiresAuth: true, requiresClinic: true },
    },
    // Queue
    {
    ...
    },
    {
      path: "/queue/tv",
      name: "queue-tv",
      component: () => import("@/pages/queue/QueueTVDisplay.vue"),
      meta: { requiresAuth: true, requiresClinic: true },
    },
    {
      path: "/queue/doctor",
      name: "doctor-queue",
      component: () => import("@/pages/queue/DoctorQueuePage.vue"),
      meta: { requiresAuth: true, requiresClinic: true },
    },
    //reports
    {
    ...
    // Admin only
    {
      path: "/admin/overview",
      name: "admin-overview",
      component: () => import("@/pages/admin/SuperAdminDashboard.vue"),
    ...
    },
    {
      ...
      meta: { requiresAuth: true, requiresClinic: true, requiresAdmin: true },
    },
    {
      path: "/admin/branding",
      name: "admin-branding",
    ...
    },
    {
      path: "/revenue/record",
      name: "revenue-record",
      component: () => import("@/pages/revenue/RecordPaymentPage.vue"),
      meta: { requiresAuth: true, requiresClinic: true },
    },
    { path: "/admin/billing", redirect: "/dashboard" },
    // Public booking — no auth
    // /book/:clinicSlug           → main clinic booking
    // /book/:clinicSlug/:branchSlug → specific branch booking
    {
      path: "/book/:clinicSlug/:branchSlug?",
      name: "booking",
...
router.beforeEach(async (to) => {
  ...
  if (
    to.meta.requiresClinic &&
    authStore.user &&
    !authStore.profile?.clinic_id &&
